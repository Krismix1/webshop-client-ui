...
describe('AppComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      fixture = TestBed.createComponent(AppComponent); // creates an instance of the AppComponent, adds a corresponding element to the test-runner DOM, and returns a ComponentFixture.
    });
  }));
